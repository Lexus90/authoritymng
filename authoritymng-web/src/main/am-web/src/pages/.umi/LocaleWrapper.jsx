...
const localeInfo = {
  'en-US': {
    messages: require('/Users/caowei/code/java/authoritymng/authoritymng-web/src/main/am-web/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: require('/Users/caowei/code/java/authoritymng/authoritymng-web/src/main/am-web/src/locales/pt-BR.js').default,
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: require('/Users/caowei/code/java/authoritymng/authoritymng-web/src/main/am-web/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: require('/Users/caowei/code/java/authoritymng/authoritymng-web/src/main/am-web/src/locales/zh-TW.js').default,
    locale: 'zh-TW',
